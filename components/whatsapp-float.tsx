...
export function WhatsAppFloat() {
  ...
  return (
    <div className="fixed bottom-5 right-4 z-40 flex items-center gap-2.5 sm:bottom-6 sm:right-6">
...
function WhatsAppIcon() {
  return (
    <svg aria-hidden="true" viewBox="0 0 24 24" className="relative h-7 w-7 fill-current">
